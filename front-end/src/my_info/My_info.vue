                ...
                <div class="listing-info-box">
                    ...
                    <div class="listing-theme-logo">
                        <img src="/media/{{ logined_user.user_pic }}" alt="" class="bg-white"
                             style="min-width: 130px; max-height: 130px; min-width: 130px; min-height: 130px;">
                    </div>
                    <div class="listing-info">
                        ...
                        <div class="listing-info-right">
                            ...
                            {% if logined_user.user_role.role_no <= 4 %}
                                <a href="{% url 'staff_member_list' %}" class="site-button"><i
                            ...
                            <form id="form-user-pic-delete" action="{% url 'user_pic_delete' %}" method="post">
                                {% csrf_token %}
            ...
            <div class="modal-dialog " role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form id="form-user-pic-update" action="{% url 'user_pic_update' %}" method="post"
                            ...
                            <a href="#" class="site-button" style="display: grid; justify-items: center;"
                               onclick="goSubmit('form-user-pic-update')">수정</a>
                        </form>
                    </div>
                </div>
            </div>
        ...
        <div class="listing-details-nav">
            <div class="container">
                <ul class="listing-nav nav">
                    ...
                    <li><a data-toggle="tab" href="#listing_myclass"><i
                            class="la la-home"></i><span>강의실</span></a></li>
                    <!--개설강의 메뉴버튼,Back : 강의자만 보이게 수정-->
                    <li><a data-toggle="tab" href="#listing_class_setting"><i
                            class="la la-book"></i><span>개설 강의 관리</span></a>
                    </li>
                    <!--작성들관리 메뉴버튼,Back : 모두에게 보이게 수정-->
                    <li><a data-toggle="tab" href="#listing_mycontent"><i
                            class="la la-list-alt"></i><span>작성 글 관리</span></a>
                    </li>
                    <!--예산신청내역 메뉴버튼,Back : 모두에게 보이게 수정-->
                    <li><a data-toggle="tab" href="#listing_mybank"><i class="la la-money"></i><span>예산 신청 내역</span></a>
                    </li>
                    <!--내정보 메뉴버튼,Back : 모두에게 보이게 수정-->
                    <li><a data-toggle="tab" href="#listing_my_info" class="active"><i
                            class="la la-user"></i><span>내 정보</span></a>
                    </li>
                </ul>
            </div>
        </div>
