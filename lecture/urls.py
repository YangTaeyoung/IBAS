...
urlpatterns = [
    ...
    path('board/register/', views.lect_board_register, name="lect_board_register"), # 강의룸 게시글 등록페이지로 이동
    path('board/hw_register/', views.lect_board_hw_register, name="lect_board_hw_register"), # 강의룸 게시글 등록페이지로 이동
]
