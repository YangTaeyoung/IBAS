...
class Bank(models.Model):
    ...
    bank_cfo = models.ForeignKey('User', models.DO_NOTHING, db_column='BANK_CFO',
                                 related_name='bank_cfo')  # Field name made lowercase.
    bank_used_user = models.ForeignKey('User', models.DO_NOTHING, db_column='BANK_USED_USER',
                                       related_name='bank_used_user')  # Field name made lowercase.
...
class ContestFile(models.Model):
    ...
    contest_no = models.ForeignKey(ContestBoard, models.DO_NOTHING,
...
class LectBoardAnswerFile(models.Model):
    ...
    lect_ans_no = models.ForeignKey(LectBoardAnswer, models.DO_NOTHING,
...
class LectBoardComment(models.Model):
    ...
    lect_board_board_no = models.ForeignKey(LectBoard, models.DO_NOTHING,
    ...
    lect_board_comment_writer = models.ForeignKey('User', models.DO_NOTHING,
    ...
    lect_board_comment_ref = models.ForeignKey('self', models.DO_NOTHING, db_column='LECT_BOARD_COMMENT_REF',
...
class LectBoardEx(models.Model):
    ...
    lect_board_no = models.ForeignKey(LectBoard, models.DO_NOTHING,
...
class LectBoardExFile(models.Model):
    lect_board_ex_file_id = models.AutoField(db_column='LECT_BOARD_EX_FILE_ID',
                                             primary_key=True)  # Field name made lowercase.
    lect_board_ex_no = models.ForeignKey(LectBoardEx, models.DO_NOTHING,
...
class User(models.Model):
    ...
    user_pic = models.CharField(db_column='USER_PIC', max_length=1000, blank=True,
                                null=True)  # Field name made lowercase.
